...
def issueBook():
    ...
    # Issue Button
    issueBtn = Button(root, text="Issue", bg='#d1ccc0', fg='black', command=lambda :lambda :issue())
    issueBtn.place(relx=0.28, rely=0.9, relwidth=0.18, relheight=0.08)

    quitBtn = Button(root, text="Quit", bg='#aaa69d', fg='black', command=lambda :lambda :root.destroy())
